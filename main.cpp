...
int main(int argc, char * argv[])
{
    ...
    while (inputLang != 5)
    {
        ...
        try
        {
            ...
            inputLang = atoi(inputString.c_str());
        }
        ...
        else if (inputLang == 1)   //English to morse code
        {
        ...
        else if (inputLang == 2)    //Morse code to english
        {
        ...
        {
            std::cout << "Please enter one of the menu options (1-5):\n";
        }
